...
public class Studentdatabase {
	...
	public static Supplier<Student> studentSupplier = () -> {
		...
		Bike bike = new Bike();
		bike.setName("Suzuki");
		bike.setModel("Gixxer SF");

		Student s = new Student("Adam", 2, 3.6, "male", Arrays.asList("swimming", "basketball", "volleyball"), 23);
	...
	public static List<Student> getAllStudents() {
		...
		Student student6 = new Student("James", 4, 3.9, "male",
				Arrays.asList("swimming", "basketball", "baseball", "football"), 16);
